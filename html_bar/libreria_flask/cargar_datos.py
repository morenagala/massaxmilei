...
('Papas boutique', 'Papas fritas gourmet', 450, 'sin_tacc', 'sin TACC'),
('Barra de ceral', 'Barra de cereal sin gluten', 290, 'sin_tacc', 'sin TACC'),
('Barra de maní', 'Barra de maní sin gluten', 200, 'sin_tacc', 'sin TACC'),
('Alfajor', 'Alfajor sin gluten relleno de dulce de leche', 420, 'sin_tacc', 'sin TACC'),
('Cuadrado coco y ddl', 'Cuadrado de coco con dulce de leche', 690, 'sin_tacc', 'sin TACC'),
('Cuadrado de brownie', 'Cuadrado de brownie sin gluten', 690, 'sin_tacc', 'sin TACC'),
('Cuadrado de pasta frola', 'Cuadrado de pasta frola sin gluten', 690, 'sin_tacc', 'sin TACC'),
...
('Sandwich de jamón y queso', 'Sándwich clásico de jamón y queso', 950, 'sanguches', ' '),
('Sandwich de jamón crudo y queso', 'Sándwich con jamón crudo y queso', 1400, 'sanguches', ' '),
('Sandwich de jamón y queso', 'Sándwich clásico de jamón y queso', 950, 'sanguches', ' '),
('Sandwich de milanesa', 'Sándwich con milanesa de carne', 1400, 'sanguches', ' '),
('Sandwich completo', 'Sándwich con jamón, queso, lechuga, tomate y mayonesa', 1550, 'sanguches', ' '),
('Sandwich de jamón crudo', 'Sándwich con jamón crudo', 1400, 'sanguches', ' '),
...
('Sandwich de salame y queso', 'Sándwich con salame y queso', 890, 'sanguches', ' '),
